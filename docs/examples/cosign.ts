...
const privateKey1 = new PrivateKey(
	"26DAA8B623D9B5C19A0754A5FA607285E18962BDE291A5699FE9745C05B66CCC",
);
const account1 = facade.createAccount(privateKey1);

// ---- アグリゲート署名Tx ------------------------------------------------------

const aggregateTransactionHash = new Hash256(
	utils.hexToUint8(
		"02959444B4C4A2A3F924E298640264DDF3D93C2E1D3625373782F776282B97A4",
	),
);
